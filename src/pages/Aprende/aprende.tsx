      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <h3 className="text-[22px] font-semibold">Teorema de Sándwich, Teorema de la acotación y el teorema de Bolzano-Weierstrass</h3>
            <div>
          ...
          <div>
            ...
            <h3 className="text-[22px] font-semibold">Relación entre límites y continuidad, y tipos de discontinuidades.</h3>
            <div>
